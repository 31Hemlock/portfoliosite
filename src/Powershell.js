...
import cover_vid from './vid/powershell.mp4'
...
function Powershell(props) {
    ...
    return (
        <div className="mainContent">
            ...
            <video id='powershell_vid'src={cover_vid} style={{width:"90%", height:'auto'}} autoPlay controls></video>
            <div className="block">
                ...
                <p style={{textAlign:"left", padding:'3%', paddingBottom:'2%'}}> The source code is available <a href="https://github.com/31Hemlock/DLYoutubeMP3">here.</a></p>
