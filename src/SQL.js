...
import cover_img from './img/sql.png'
    ...
    return (
        <div className="mainContent">
            ...
            <div className="block">
                ...
                <p style={{textAlign:"left", padding:'3%', paddingBottom:'2%'}}> The SQL file can be found <a href="https://github.com/31Hemlock/SQLProject">here</a>.</p>
