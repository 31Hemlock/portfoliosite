    ...
    return (
        ...
        <div className="mainContent">
            ...
            <div className="block">
                ...
                <p style={{marginBottom:'0px'}}> I feed the data I gather from <a href="portfoliosite/python-data-manipulation">Python Data Manipulation</a> to a machine learning algorithm that I am still developing.</p>
                ...
                <h4>Source Code</h4>
                <p>The source code is available <a href="https://github.com/31Hemlock/NovaRainBot">here.</a></p>
