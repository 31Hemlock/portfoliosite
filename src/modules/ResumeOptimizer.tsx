...
export const ExcelTabContent: TabContentData = {
  ...
  content: (
    <>
      <ContentCard>
        <p className={`${mainHeaderClasses}`}>{ExcelCoreTabContent.subtitle}</p>
        {divider}
        <p className={`${paragraphClasses}`}>
          Attached to{' '}
          <LinkWrapper url={`${CodeLink}ExcelSheets`} text="this link" /> are
          some of my Excel spreadsheets that contain advanced formulas or
          macros.
        </p>
      </ContentCard>
    </>
