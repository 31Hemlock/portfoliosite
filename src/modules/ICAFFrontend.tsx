    ...
    <>
      <ContentCard>
        ...
        <p className={`${paragraphClasses}`}>
          Shortly after starting to volunteer with ICAF, I was assigned the task
          of implementing a new frontend design to make{' '}
          <LinkWrapper url={`https://www.icaf.org`} text="the ICAF website" />{' '}
          fully responsive across all screen sizes.
        </p>
        <p className={`${paragraphClasses}`}>
          In addition to making the website responsive, I drastically reduced
          image sizes (using command-line tools like{' '}
          <LinkWrapper url={`https://www.ffmpeg.org/`} text="ffmpeg" /> and{' '}
          <LinkWrapper
            url={`https://imagemagick.org/index.php`}
            text="Imagemagick"
          />
          ) and prevented the preloading of videos upon page load, drastically
          reducing load times and total data transferred. This is particularly
          significant in regions with slower internet speeds, especially
          considering the global reach of the organization.
        </p>
        <p className={`${leftMainHeaderClasses}`}>Technology</p>
        {divider}
        <p className={`${paragraphClasses}`}>
          To make <LinkWrapper url={`https://www.icaf.org`} text="Icaf.org" />{' '}
          responsive, I worked with <SB>HTML</SB>, <SB>Javascript</SB>, and{' '}
          <SB>SCSS</SB>. I also used <SB>FTP</SB> programs like{' '}
          <LinkWrapper url={`https://winscp.net/eng/index.php`} text="WinSCP" />{' '}
          to push these changes to our server.
        </p>
      </ContentCard>
      <ContentCard>
