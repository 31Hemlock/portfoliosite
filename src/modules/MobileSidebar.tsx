    ...
    return (
        <>
            ...
            <div className="w-full mx-auto px-6 py-2">
                <Link to='/' className="text-header-white mx-auto text-center block text-3xl  hover:text-hover-highlight w-max " onClick={() => setMobileShowMenu(false)}>Noah Zaranka</Link> 
            </div>
