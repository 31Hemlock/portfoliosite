    ...
    <>
      <ContentCard>
        ...
        <p className={`${paragraphClasses}`}>
          In college I worked on a three person group project to create an
          e-commerce website complete with <SB>PHP</SB> scripting and an{' '}
          <SB>SQL</SB> backend. My personal contributions to the project are
          shown in the video. The website allows users to log in, find games to
          purchase or rent, and order them. It maintains their cart and purchase
          history in the SQL database, and also allows admins to edit game
          information natively without touching SQL code. Each of the forms has
          error-checking and submits to the database.
        </p>
      </ContentCard>
      <ContentCard>
        ...
        <p className={`${paragraphClasses}`}>
          ...
          <LinkWrapper url={`${CodeLink}WebcommerceProject`} text="here" />.
        </p>
      </ContentCard>
    </>
  ),
